...
$.formValidator = 
{
	...
	//设置错误正确的显示信息
	setFailState : function(tipID,showclass,showmsg)
	{
	    var tip = $("#"+tipID);
	    tip.removeClass().addClass(showclass).html(showmsg);
	},
	...
	ajaxValid : function(returnObj)
	{
		...
		ls_url = ls_url + (ls_url.indexOf("?") > -1 ? ("&" + parm) : ("?" + parm)) + "&"+id+"="+encodeURI(encodeURI($("#"+id).val()));
		...
		{	
			...
			success : function(data, textStatus, jqXHR){
				...
				{
					//alert(initConfig.submitButtonID);
