...
(function ($)
{
    ...
    $.ligerDefaults.Tree = {
        ...
        singleSiblingExpand: false     //是否同级节点中只能展开一个节点
    };
    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        {
        	if(typeof treenodedata === 'object' && treenodedata.data) treenodedata = treenodedata.data;
            ...
            //===================20130130注释以下代码（原插件中的代码，）已经被上面段代码代替================
            //return treenodedata.children.length>0 ? true : false;
        },
        //获取父节点 数据
        ...
        {
            var g = this, p = this.options;
            if (!this.options.checkbox) return null;  ///l-checkbox-incomplete
            var nodes = [];
           ...
           //获取选中和未选中的数据===================================================20130125加入代码获取未完全选中的节点========================================
        ...
        collapseSibling: function(refNode) {
        	$(refNode.target).siblings().filter(function(i){
        		return $("> div > div.l-expandable-open",this).length > 0;
        	}).click();
        },
        expandAll: function ()
        {
            ...
            {   
               ...
               if(o.checked=="checked"){
                ...
                if (g.hasChildren(o))
                {
                    ...
                    //========================改动过================20130125
                        if (o.ischecked){
                            treehtmlarr.push('<div class="l-box l-checkbox l-checkbox-checked"     id="lid' + o.id + '" >');
                        }else if(o.checked=='inchecked'){
                        	treehtmlarr.push('<div class="l-box l-checkbox l-checkbox-incomplete"  id="lid' + o.id + '" >');
						 }else{
                            treehtmlarr.push('<div class="l-box l-checkbox l-checkbox-unchecked"   id="lid' + o.id + '" >');
                        }
                ...
                else
                {
                    ...
                    //========================改动过================20130125
                        if (o.ischecked){
                            ...
                            treehtmlarr.push('<div class="l-box l-checkbox l-checkbox-checked"     id="lid' + o.id + '" >');
                        }else if(!o.isChecked&&o.checked=='inchecked'){
            ...
            { 
                ...
                else if (treeitembtn.hasClass("l-expandable-close") && (!p.btnClickToToggleOnly || clickOnTreeItemBtn))
                {
                    if (g.trigger('beforeExpand', [{ data: treenodedata, target: treeitem[0]}]) == false)
                        return false;
                    // 如果设置了singleSiblingExpand,则在展开节点前将其展开状态的兄弟节点闭合
                    if(p.singleSiblingExpand) {
                    	treeitem.siblings().filter(function(i){
			        		return $("> div > div.l-expandable-open",this).length;
			        	}).click();
                    }
