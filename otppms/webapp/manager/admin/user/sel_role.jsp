...
<html>
  <head>
	...
	<script language="javascript" src="<%=path%>/manager/admin/user/js/sel_role.js"></script>
  ...
  <body scroll="no" style="overflow:auto; overflow-x:hidden">
	  <form name="ListForm" method="post" action="">
	   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:8px;">
		<tr>
		 <td>
		    <span class="query-font-css"><view:LanguageTag key="admin_role_name"/><view:LanguageTag key="colon"/>
		    	<input type="text" id="roleName" name="queryForm.roleName" value="${queryForm.roleName}" class="form-text" style="width:140px"/>&nbsp;&nbsp;
		    	<div style="display:none"><input type="text" id="roleT" name="queryForm.roleName" class="formCss"/></div>  
