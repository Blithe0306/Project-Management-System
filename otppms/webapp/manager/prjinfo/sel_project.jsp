...
<html>
  <head>
	...
	<script language="javascript" src="<%=path%>/manager/prjinfo/js/sel_project.js"></script>
  ...
  <body scroll="no" style="overflow:auto; overflow-x:hidden">
	  <form name="ListForm" method="post" action="">
	   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:8px;">
		<tr>
		 <td>
		    <span class="query-font-css">定制项目名称<view:LanguageTag key="colon"/>
		    	<input type="text" id="prjname" name="projectQueryForm.prjname" value="${projectQueryForm.prjname}" style="width:140px"/>&nbsp;&nbsp;
		    	<div style="display:none"><input type="text" id="roleT" name="projectQueryForm.prjname" class="formCss"/></div>  
