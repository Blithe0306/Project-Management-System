...
<html>
	...
	<script language="javascript" type="text/javascript">
		...
		$(function(){
			...
			window.setInterval(function(){
				refreshData(new Array('appListDataAJAX','serverListDataAJAX'));
			},"5000");
		});
  ...
  <body scroll="no" style="overflow:auto; overflow-x:hidden">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="topTableBg">
      <tr>
        <td>  
        	 <view:LanguageTag key="monitor_app_sys_online_info"/>
        </td>
        <td width="16px">
	    	<a href="javascript:addAdmPermCode('0901','<%=path%>');" class="isLink_HeiSe"><img src="<%=path%>/images/icon/rightarrow.png" width="16" height="16" hspace="6" title='<view:LanguageTag key="common_admin_keep_used"/>'/></a>	    </td>
      </tr>
    </table>     
 	<div id="appListDataAJAX"></div>
 	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="topTableBg">
      <tr>
        <td>  
        	 <view:LanguageTag key="monitor_auth_ser_health"/>
        </td>
      </tr>
    </table>
    <div id="serverListDataAJAX"></div>
  </body>
</html>
