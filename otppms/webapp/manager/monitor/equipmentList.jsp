      ...
      <tr>
        <td>  
        	<view:LanguageTag key="monitor_all_device_list"/>
		     <!--<view:AdminPermTag key="010002" path="<%=path%>" langKey="common_syntax_add" type="3"  />
		     <view:AdminPermTag key="010004" path="<%=path%>" langKey="common_syntax_delete" type="3" />
		     <view:AdminPermTag key="010006" path="<%=path%>" langKey="admin_info_change_0" type="3"/>
		     -->
        </td>
        <td width="16px">
