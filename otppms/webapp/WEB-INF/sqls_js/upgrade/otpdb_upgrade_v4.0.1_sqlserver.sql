...
-- ALTER TABLE otppms_attrinfo DROP CONSTRAINT fk_attrinfo_rad_profile_profileid; 
-- ALTER TABLE otppms_attrinfo ADD CONSTRAINT fk_attrinfo_rad_profile_profileid PRIMARY KEY(attrid, profileid,vendorid);
