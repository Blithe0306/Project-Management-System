package com.ft.otp.util.properties;
 ...
 * 格式化读取Properties文件
 *
 * @Date in Mar 12, 2010,2:15:00 PM
 *
 * @author TBM
 */
public class BaseProperties extends Properties {

    private static final long serialVersionUID = 1842710390060303298L;
